...
-- Scale tables
local VERT_SCALE_TABLE = {100, 150, 250, 500, 1000, 2500, 5000, 10000, 15000, 20000, 30000}
local HORZ_SCALE_TABLE = {1.0, 1.3333, 1.6666, 2.0, 4.0, 10.0, 20.0, 40.0, 100.0, 200.0, 1000.0}

-- Horizontal scroll constants
local NUM_SAMPLES_QEP = 29239
local NUM_SAMPLES_ANALOG = 4873
local HORZ_SCROLL_SPEED = 0.5
